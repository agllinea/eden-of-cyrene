...
export const cls = {
	...
	/** Copy icon — brand on hover, with a comfortable touch target */
	btnIconCopy:  "p-1.5 -m-1.5 rounded-lg text-slate-300 hover:text-pw-500 hover:bg-pw-100 transition-colors",
